...
class plate_reader:
  ...
  def __init__(self):
    ...
    self.alpha_model = models.load_model('/home/fizzer/ros_ws/src/enph353_comp_controller/src/plate_models/alpha_model.h5')
    self.num_model = models.load_model('/home/fizzer/ros_ws/src/enph353_comp_controller/src/plate_models/num_model.h5')
